...
public:
    explicit PrivatePrecache(ServerEventsManager& server_events_manager, NclmProtocol& nclm_protocol, INextClientInfo& next_client_info);
...
private:
    ...
    void TrySendPrivateResourceListLocation(ClientId client_id);
...
struct PrivatePrecacheService
    : kgr::single_service<PrivatePrecache, kgr::dependency<ServerEventsManagerService, NclmProtocolService, INextClientInfoService>>
{};
