...
namespace cssdk
{
     ...
     * @brief N/D
    */
    constexpr auto ENGINE_LIB = "swds.dll";
#else
    /**
     * @brief N/D
    */
    constexpr auto ENGINE_LIB = "engine_i486.so";
#endif

    /**
     * @brief N/D
    */
    constexpr auto VENGINE_HLDS_API_VERSION = "VENGINE_HLDS_API_VERSION002";

    class IDedicatedServerApi : public SysInterfaceBase
    {
    public:
        /**
         * @brief N/D
        ...
        */
         ...
         * @brief N/D
        */
        virtual void UpdateStatus(float* fps, int* active, int* max_players, char* map) = 0;
    };
}
